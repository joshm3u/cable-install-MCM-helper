...
(function() {
   ...
   // Function to prompt the user for input
    function getUserInputAndReplace() {
        ...
        const userInput12 = "Manual_Input_Here"; // Predefined input for 12_list_all_hostnames_locations_production_status_and_if_in_scope_of_this_activity
        const userInput13 = "Manual_Input_Here"; // Predefined input for 13_patch_panels_and_locations_if_applicable
        ...
        const userInput15 = "No"; // Predefined input for 15_are_there_any_related_MCMs_that_must_be_completed_before_this_change_occurs
        const userInput16 = "Yes, Add_NDE_cutsheet_here"; // Predefined input for 16_are_the_Cut_sheet_MCMs_in_a_fully_approved_state_if_yes_list_them_below_and_attach_them_in_related_items
        ...
        const userInput20 = "Manual_Input_Here"; // Predefined input for 20_timeline_or_activity_plan
